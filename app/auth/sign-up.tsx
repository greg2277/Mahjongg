...
export default function SignUpScreen() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: theme.bg }}>
      ...
      >
        <Field label="Display name" value={name} onChange={setName} placeholder="Your table name" />
        <Field
          label="Email"
          value={email}
          onChange={setEmail}
        ...
        <View style={{ marginTop: 6, marginBottom: 12 }}>
          <Text style={{ color: theme.textSubtle, fontSize: 12, lineHeight: 18 }}>
            We will email a verification link valid for 24 hours. You must verify before your first sign-in.
          </Text>
        </View>
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12, marginVertical: 18 }}>
          ...
          <Text style={{ color: theme.textSubtle, fontSize: 12, fontWeight: '700', letterSpacing: 1 }}>OR</Text>
          <View style={{ flex: 1, height: 1, backgroundColor: theme.border }} />
        </View>
        ...
        >
          ...
          <Text style={{ color: theme.text, fontSize: 15, fontWeight: '700' }}>Continue with Google</Text>
        </Pressable>
